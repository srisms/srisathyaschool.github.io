...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Sri Sathya School Website &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/srisathyaschoolwebsitewp/srisathyaschool.github.io/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Sri Sathya School Website</a>		</p>
			</div>
	<script src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script id="zxcvbn-async-js-extra">
var _zxcvbnSettings = {"src":"http:\/\/localhost\/srisathyaschoolwebsitewp\/srisathyaschool.github.io\/wp-includes\/js\/zxcvbn.min.js"};
</script>
...
var _wpUtilSettings = {"ajax":{"url":"\/srisathyaschoolwebsitewp\/srisathyaschool.github.io\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/wp-includes/js/wp-util.min.js?ver=5.8.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"55ddc48ad9"};
</script>
